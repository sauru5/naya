...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n\n<h1>{{title}}</h1>\n<nav>\n    <a routerLink=\"/dashboard\">Background</a>\n  <a routerLink=\"/heroes\">Inspiring Person</a>\n</nav>\n<router-outlet></router-outlet>\n<app-messages></app-messages>\n"
...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Want to Know more about Saurav!';
    }
...
module.exports = "<h3>Saurav Identity</h3>\n<div class=\"grid grid-pad\">\n  <a *ngFor=\"let hero of heroes\" class=\"col-1-4\"\n      routerLink=\"/detail/{{hero.id}}\">\n    <div class=\"module hero\">\n      <h4>{{hero.name}}</h4>\n    </div>\n  </a>\n</div>\n"
...
var HEROES = [
    { id: 11, name: 'Newton' },
    { id: 12, name: 'BP Koirala' },
    { id: 13, name: 'Mahavir Pun' },
    { id: 14, name: 'Sandeep Lamichhane' },
    { id: 15, name: 'Ramanujan' },
    { id: 16, name: 'Baburam' },
    { id: 17, name: 'Dynama' },
    { id: 18, name: 'Prithivi Narayan Shah' },
    { id: 19, name: 'Magma' },
    { id: 20, name: 'Tornado' }
];
...
module.exports = __webpack_require__(/*! C:\Users\Saurav\my-app\src\main.ts */"./src/main.ts");
